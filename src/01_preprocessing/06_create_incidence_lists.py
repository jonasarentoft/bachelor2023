...
if __name__ == "__main__":
    ...
    # with open(f"{mypath}/edgesWithDistances.txt", "r") as edgesAndDistances:
    #     with open(f"{mypath}/E_reversed.txt", "w") as E:
    #         with open(f"{mypath}/V_reversed.txt", "w") as V:
    #             with open(f"{mypath}/W_reversed.txt", "w") as W:
    ...
    # # MAC
    # elif os.name == 'posix':
    #     os.system(f'SORT {FILEPATH}/{FOLDERNAME}/edgesWithDistances.txt -o {FILEPATH}/{FOLDERNAME}/edgesWithDistances.txt -T /volumes/T7/jonas_bachelor2023/TEMP ')
                            
    with open(f"{mypath}/edgesWithDistances.txt", "r") as edgesAndDistances:
        with open(f"{mypath}/E.txt", "w") as E:
            with open(f"{mypath}/V.txt", "w") as V:
                with open(f"{mypath}/W.txt", "w") as W:
